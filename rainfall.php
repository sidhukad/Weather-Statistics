...
$qry = "select MAX(RainFall) as 'MaxRain' from climate1 where State='$state' and Year='$year' group by Month ";
...
$qry = "select MIN(RainFall) as 'MinRain' from climate1 where State='$state' and Year='$year' group by Month";
$result=mysql_query($qry,$con) or die("\nError in execution: ".mysql_error());
$rows1 = array();
$rows1['name'] = 'Minimum' ;
while($rr = mysql_fetch_assoc($result)) {
	$rows1['data'][] = $rr['MinRain'] ;
}
...
<div class="container">
      ...
      <div class="masthead">
        ...
        <ul class="nav nav-justified">
          ...
          <li class="active"><a href="rainfall.php?state=<?php echo $state?>&year=<?php echo $year?>&button=submit">Rain Fall</a></li>
